...
namespace Print.Message.Bll
{
    public class PrintMessageBLL
    {
        ...
        public bool UpdateVipAndBatAndMacAndEquAndRFIDBLL(string IMEI, string SIM, string VIP, string BAT, string ICCID, string MAC, string Equipment, string RFID)
        {
            if (PMD.UpdateVipAndBatAndMacAndEquAndRFIDDAL(IMEI, SIM, VIP, BAT, ICCID, MAC,Equipment,RFID) > 0)
            {
                return true;
            }
            else
