            ...
            using (SqlCommand command = conn1.CreateCommand())
            {
                ...
                while (dr.Read())
                {
                    list.Add(new Gps_ManuOrderParam()
                    {
                        ...
                        IMEI2Start = dr.IsDBNull(52) ? "" : dr.GetString(52),
                        IMEI2End = dr.IsDBNull(53) ? "" : dr.GetString(53),
                        IMEI2Prints = dr.IsDBNull(54) ? "" : dr.GetString(54),
        ...
        public Gps_ManuOrderParam selectManuOrderParamByzhidanDAL(string ZhidanNum,int NullInt)
        {
            ...
            using (SqlCommand command = conn1.CreateCommand())
            {
                ...
                while (dr.Read())
                {
                    ...
                    list.RFIDStart = dr.IsDBNull(48) ? "" : dr.GetString(48);
                    list.RFIDEnd = dr.IsDBNull(49) ? "" : dr.GetString(49);
                    list.RFID_prefix = dr.IsDBNull(50) ? "" : dr.GetString(50);
                    list.RFID_digits = dr.IsDBNull(51) ? "" : dr.GetString(51);
                }
                return list;
            }
        }
