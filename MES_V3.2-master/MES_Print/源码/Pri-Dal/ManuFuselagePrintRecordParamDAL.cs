            ...
            using (SqlCommand command = conn1.CreateCommand())
            {
                ...
                while (dr.Read())
                {
                    list.Add(new ManuFuselagePrintRecordParam()
                    {
                        ...
                        JSCheckIMEI2Mark = dr.IsDBNull(29) ? 0 : dr.GetInt32(29),
                        JSCheckInseIMEI2Mark = dr.IsDBNull(30) ? 0 : dr.GetInt32(30)
                    });
                }
                return list;
            }
