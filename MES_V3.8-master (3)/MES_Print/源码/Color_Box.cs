...
namespace WindowsForms_print
{
    public partial class Color_Box : Form
    {
        ...
        private void CB_ZhiDan_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            GetZhidanInformation(ZhidanNum);
        ...
        private void ClearAll()
        {
            ...
            this.IMEINumCombo.Items.Clear();
            this.IMEINumCombo.Text = "";
        ...
        private void Re_IMEINum_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == 13)
            {
                if (this.Re_IMEINum.Text != "")
                {
                    ...
                    int IMEI_Len = SlipIMEIStart.Length;
                    if (this.Re_IMEINum.Text.Length == 15 && IMEI_Len == 14)
                    {
                        if (long.Parse(this.Re_IMEINum.Text.Substring(0, IMEI_Len)) < long.Parse(SlipIMEIStart) || long.Parse(this.Re_IMEINum.Text.Substring(0, IMEI_Len)) > long.Parse(SlipIMEIEnd))
                        {
                            player.Play();
                ...
                if (e.KeyChar == 13)
                {
                    ...
                    if (this.NoCheckCode.Checked == false)//打印校验码
                    {
                        ...
                        if (IsNumeric(this.IMEI_Start.Text) && this.IMEI_Start.Text.Length == 15)
                        {
                            ...
                            if (IMEI_Start < long.Parse(SlipIMEIStart) || IMEI_Start > long.Parse(SlipIMEIEnd))
                            {
                                player.Play();
                    ...
                    if (CheckFields.Count != 0)
                    {
                        ...
                        if (this.CheckSIM.Checked == true)
                        {
                            ...
                            {
                                if (PMB.CheckSIMbudingIMEIBLL(this.SIMStart.Text, this.IMEI_Start.Text))
                                {
                                    player.Play();
                        ...
                        if (this.CheckICCID.Checked == true)
                        {
                            ...
                            {
                                if (PMB.CheckICCIDbudingIMEIBLL(this.ICCIDStart.Text, this.IMEI_Start.Text))
                                {
                                    player.Play();
                        ...
                        if (this.CheckMAC.Checked == true)
                        {
                            ...
                            {
                                if (PMB.CheckMACbudingIMEIBLL(this.MACStart.Text, this.IMEI_Start.Text))
                                {
                                    player.Play();
                        ...
                        if (this.CheckEquipment.Checked == true)
                        {
                            ...
                            {
                                if (PMB.CheckEquipmentbudingIMEIBLL(this.EquipmentStart.Text, this.IMEI_Start.Text))
                                {
                                    player.Play();
                        ...
                        if (this.CheckVIP.Checked == true)
                        {
                            ...
                            {
                                if (PMB.CheckVIPbudingIMEIBLL(this.VIPStart.Text, this.IMEI_Start.Text))
                                {
                                    player.Play();
                        ...
                        if (this.CheckBAT.Checked == true)
                        {
                            ...
                            {
                                if (PMB.CheckBATbudingIMEIBLL(this.BATStart.Text, this.IMEI_Start.Text))
                                {
                                    player.Play();
                        ...
                        if (this.CheckRFID.Checked == true)
                        {
                            ...
                            {
                                if (PMB.CheckRFIDbudingIMEIBLL(this.RFIDStart.Text, this.IMEI_Start.Text))
                                {
                                    player.Play();
            ...
            try
            {
                if (e.KeyChar == 13)
                {
                    ...
                    if (this.SIMStart.Text != "")
                    {
                        ...
                        //分割字符串
                        this.SIMStart.Text = SustringPos(this.SIMStart.Text);
        ...
        private void VIPStart_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == 13)
            {
                ...
                {
                    //分割字符串
                    this.VIPStart.Text = SustringPos(this.VIPStart.Text);
        ...
        private void BATStart_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == 13)
            {
                ...
                {
                    //分割字符串
                    this.BATStart.Text = SustringPos(this.BATStart.Text);
        ...
        private void ICCIDStart_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == 13)
            {
                ...
                {
                    //分割字符串
                    this.ICCIDStart.Text = SustringPos(this.ICCIDStart.Text);
        ...
        private void MACStart_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == 13)
            {
                ...
                {
                    //分割字符串
                    this.MACStart.Text = SustringPos(this.MACStart.Text);
        ...
        private void EquipmentStart_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == 13)
            {
                ...
                {
                    //分割字符串
                    this.EquipmentStart.Text = SustringPos(this.EquipmentStart.Text);
        ...
        private void RFIDStart_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == 13)
            {
                ...
                if (this.RFIDStart.Text != "")
                {
                    ...
                    //分割字符串
                    this.RFIDStart.Text = SustringPos(this.RFIDStart.Text);
        ...
        private void ToLock_Click(object sender, EventArgs e)
        {
            ...
            int itme = 0;
            string[] IMEI = this.IMEINumCombo.Text.Split(',');
            ...
            this.IMEINumCombo.Enabled = false;
        ...
        public void unlock_content()
        {
            ...
            this.IMEINumCombo.Enabled = true;
        ...
        {
            //获取状态0、1、2制单数据
            Gps_ManuOrderParam b = MOPB.selectManuOrderParamByzhidanBLL(Zhidan, 0);
            if (b.status == 0)
            {
                ...
                this.Week_count.ReadOnly = false;
            ...
            //根据第一次订单打印成功做记忆功能
            mprp = MPRPB.selectRecordParamByzhidanBLL(Zhidan);
        ...
        public void InitIMEIArry()
        {
            ...
            foreach (var range in RangeIMEI)
            {
                ...
                this.IMEINumCombo.Items.Add(range);
        ...
        {
            this.IMEINumCombo.Items.Clear();
            this.IMEINumCombo.Items.Add(this.IMEI_num1.Text + "," + this.IMEI_num2.Text);
            ...
            this.IMEINumCombo.SelectedIndex = 0;
        }
        ...
        public void  MODE2()
        {
            ...
            btFormat.SubStrings["ProductDate"].Value = this.PrintDate.Text;
            btFormat.Print();
            Form1.Log("使用模板2打印了IMEI号:" + IMEI + ",SN:" + DZSN + ",SIM卡号:" + SIM + ",电池号:" + BAT + ",VIP号:" + VIP + ",蓝牙号:" + MAC + ",ICCID号:" + ICCID + ",设备号:" + Equipment + ",RFID:" + RFID + ", IMEI14:" + G_IMEI14 + " 的彩盒贴制单", null);
