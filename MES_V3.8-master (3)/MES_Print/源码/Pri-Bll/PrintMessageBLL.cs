...
namespace Print.Message.Bll
{
    public class PrintMessageBLL
    {
        ...
        public bool CheckSIMbudingIMEIBLL(string SIM,string IMEI)
        {
            if (PMD.CheckSIMbudingIMEIDAL(SIM, IMEI) > 0)
            {
                return true;
            }
            else
        ...
        public bool CheckVIPbudingIMEIBLL(string VIP, string IMEI)
        {
            if (PMD.CheckVIPbudingIMEIDAL(VIP, IMEI) > 0)
            {
                return true;
            }
            else
        ...
        public bool CheckBATbudingIMEIBLL(string BAT, string IMEI)
        {
            if (PMD.CheckBATbudingIMEIDAL(BAT, IMEI) > 0)
            {
                return true;
            }
            else
        ...
        public bool CheckICCIDbudingIMEIBLL(string ICCID, string IMEI)
        {
            if (PMD.CheckICCIDbudingIMEIDAL(ICCID, IMEI) > 0)
            {
                return true;
            }
            else
        ...
        public bool CheckMACbudingIMEIBLL(string MAC, string IMEI)
        {
            if (PMD.CheckMACbudingIMEIDAL(MAC, IMEI) > 0)
            {
                return true;
            }
            else
        ...
        public bool CheckEquipmentbudingIMEIBLL(string Equipment, string IMEI)
        {
            if (PMD.CheckEquipmentbudingIMEIDAL(Equipment, IMEI) > 0)
            {
                return true;
            }
            else
        ...
        public bool CheckRFIDbudingIMEIBLL(string RFID, string IMEI)
        {
            if (PMD.CheckRFIDbudingIMEIDAL(RFID, IMEI) > 0)
            {
                return true;
            }
            else
