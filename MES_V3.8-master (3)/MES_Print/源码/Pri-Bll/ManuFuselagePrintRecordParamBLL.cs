    ...
    class ManuFuselagePrintRecordParamBLL
    {
             ...
             int JSCheckSnMark, int JSCheckSimMark, int JSCheckBatMark, int JSCheckIccidMark, int JSCheckMacMark, int JSCheckEquipmentMark, int JSCheckVipMark, int JSCheckRfidMark ,int PrintMode1,int PrintMode2, int JSCheckIMEI2Mark, int JSCheckInseIMEI2Mark,int RfidMark, string IMEI_Prefix, string IMEI_Suffix)
        {
            if (FPRPD.InsertFuselagePrintRecordParamDAL(Zhidan, PrintOneByOne, Pltplot, CustomerSupplySN, NoPrintCheckCode, NoPrintingSN, IMEIHexadecimal, SNHexadecimal, ReplayOneByOne, BattingInBatches, NoParityBit, Hexadecimal,
              JSCheckSnMark,  JSCheckSimMark,  JSCheckBatMark,  JSCheckIccidMark,  JSCheckMacMark,  JSCheckEquipmentMark,  JSCheckVipMark,  JSCheckRfidMark,  PrintMode1,  PrintMode2,  JSCheckIMEI2Mark,  JSCheckInseIMEI2Mark,  RfidMark, IMEI_Prefix, IMEI_Suffix) > 0)
            {
                return true;
            }
            else
