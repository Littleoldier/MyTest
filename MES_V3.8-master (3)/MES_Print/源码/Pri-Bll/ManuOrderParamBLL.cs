...
namespace ManuOrder.Param.BLL
{
    public class ManuOrderParamBLL
    {
        ...
        {
           return MOPD.UpdateInlineByZhiDanDAL(ZhiDanNum,SN1,SN2,ProductData,SIM1,SIM2,SIM_dig,SIM_pre,VIP1,VIP2,VIP_dig,VIP_pre,BAT1,BAT2,BAT_dig,BAT_pre, ICCID_dig, ICCID_pre, MAC_dig, MAC_pre, Equipment_dig, Equipment_pre,  RFID_Num1,  RFID_Num2,  RFID_prefix,  RFID_digits,  Week);
        }
