                ...
                if (this.VIPStart.Text != "")
                {
                    ...
                    if (AssociatedFields.Count == 1)
                    {
                        ...
                        else
                        {
                            ...
                            if (UpInt == 2)
                            {
                                this.reminder.AppendText(this.VIPStart.Text + "绑定" + this.IMEI_Start.Text + "\r\n");
                                player4.Play();
                            }
                            this.IMEI_Start.Clear();
                            this.SIMStart.Clear();
                ...
                if (this.BATStart.Text != "")
                {
                    ...
                    if (AssociatedFields.Last().Value == "BAT")
                    {
                        ...
                        else
                        {
                            ...
                            if (UpInt == 2)
                            {
                                this.reminder.AppendText(this.BATStart.Text + "绑定" + this.IMEI_Start.Text + "\r\n");
                                player4.Play();
                            }
                            this.IMEI_Start.Clear();
                            this.SIMStart.Clear();
                ...
                if (this.ICCIDStart.Text != "")
                {
                    ...
                    if (AssociatedFields.Last().Value == "ICCID")
                    {
                        ...
                        else
                        {
                            ...
                            if (UpInt == 2)
                            {
                                this.reminder.AppendText(this.ICCIDStart.Text + "绑定" + this.IMEI_Start.Text + "\r\n");
                                player4.Play();
                            }
                            this.IMEI_Start.Clear();
                            this.SIMStart.Clear();
                ...
                if (this.MACStart.Text != "")
                {
                    ...
                    if (AssociatedFields.Last().Value == "MAC")
                    {
                        ...
                        else
                        {
                            ...
                            if (UpInt == 2)
                            {
                                this.reminder.AppendText(this.MACStart.Text + "绑定" + this.IMEI_Start.Text + "\r\n");
                                player4.Play();
                            }
                            this.IMEI_Start.Clear();
                            this.SIMStart.Clear();
                ...
                if (this.EquipmentStart.Text != "")
                {
                    ...
                    if (AssociatedFields.Last().Value == "Equipment")
                    {
                        ...
                        else
                        {
                            ...
                            if (UpInt == 2)
                            {
                                this.reminder.AppendText(this.EquipmentStart.Text + "绑定" + this.IMEI_Start.Text + "\r\n");
                                player4.Play();
                            }
                            this.IMEI_Start.Clear();
                            this.SIMStart.Clear();
