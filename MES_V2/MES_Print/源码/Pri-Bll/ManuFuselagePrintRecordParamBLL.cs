    ...
    class ManuFuselagePrintRecordParamBLL
    {
            ...
            int JSCheckSnMark, int JSCheckSimMark, int JSCheckBatMark, int JSCheckIccidMark, int JSCheckMacMark, int JSCheckEquipmentMark, int JSCheckVipMark, int JSCheckRfidMark ,int PrintMode1,int PrintMode2)
        {
            if (FPRPD.InsertFuselagePrintRecordParamDAL(Zhidan, PrintOneByOne, Pltplot, CustomerSupplySN, NoPrintCheckCode, NoPrintingSN, IMEIHexadecimal, SNHexadecimal, ReplayOneByOne, BattingInBatches, NoParityBit, Hexadecimal,
             JSRelationSnMark,  JSRelationSimMark,  JSRelationBatMark,  JSRelationIccidMark,  JSRelationMacMark,  JSRelationEquipmentMark,  JSRelationVipMark,  JSRelationRfidMark,
             JSCheckSnMark,  JSCheckSimMark,  JSCheckBatMark,  JSCheckIccidMark,  JSCheckMacMark,  JSCheckEquipmentMark,  JSCheckVipMark,  JSCheckRfidMark,  PrintMode1,  PrintMode2) > 0)
            {
                return true;
            }
            else
